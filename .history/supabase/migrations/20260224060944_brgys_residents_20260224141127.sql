...
alter
    publication supabase_realtime add table brgys_residents;
...
CREATE TRIGGER handle_times
    BEFORE INSERT OR UPDATE ON brgys_residents
    FOR EACH ROW
EXECUTE PROCEDURE handle_times();


create index idx_brgys_residents_suffix_id ON brgys_residents(suffix_id);
create index idx_brgys_residents_civil_status_id ON brgys_residents(civil_status_id);
create index idx_brgys_residents_sitio_id ON brgys_residents(sitio_id);
create index idx_brgys_residents_status_id ON brgys_residents(status_id);

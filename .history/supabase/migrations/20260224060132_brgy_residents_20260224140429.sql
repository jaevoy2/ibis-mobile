...
alter
    publication supabase_realtime add table brgy_residents;
...
CREATE TRIGGER handle_times
    BEFORE INSERT OR UPDATE ON brgy_residents
    FOR EACH ROW
EXECUTE PROCEDURE handle_times();


create index idx_brgy_residents_suffix_id ON brgy_residents(suffix_id);
create index idx_brgy_residents_civil_status_id ON brgy_residents(civil_status_id);
create index idx_brgy_residents_sitio_id ON brgy_residents(sitio_id);
create index idx_brgy_residents_status_id ON brgy_residents(status_id);

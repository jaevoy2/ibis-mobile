                ...
                {votingRegistration.map(({ label, key, value }, index) => (
                  <View key={index} style={{ width: '100%', marginBottom: label != 'Voting Eligibility' ? 12 : 0 }}>
                    ...
                    {label == 'Registered Voter' && residentData?.[key] == true && (
                      <View style={{ flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: '#C6C6C6', borderRadius: 8, paddingHorizontal: 10, width: '100%', marginBottom: 12 }}>
                        <Dropdown
                          style={{
                            width: '90%'
                          }}
                          ...
                          valueField="value"
                          placeholder="Select Sitio"
                          // value={residentData?.registered_brgy ?? }
                          onChange={item => handleOnChange('sitio_id', item.value)}
                        />
                        <TouchableOpacity style={{ borderLeftWidth: 1, borderLeftColor: '#C6C6C6' }}>

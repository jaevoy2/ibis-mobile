...
export default function ResidentForm() {
  ...
  const handleAddEducation = () => [
    setResidentData(prev => {
      if(!prev) return { school: [{} as SchoolProps] } as ResidentData;

      return {
        ...prev,
        school: prev.school ? [...prev.school, {} as SchoolProps]: [{} as SchoolProps]
      }
    })
  ]
  ...
  const handleSchoolChange = <K extends keyof SchoolProps>(
    index: number,
    key: K,
    value: SchoolProps[K]
  ) => {
    setResidentData((prev) => {
      ...
      if (!schools[index]) schools[index] = {} as SchoolProps;
          ...
          <ScrollView style={{ padding: 16 }}>
            ...
            <View style={{ borderColor: '#C6C6C6', borderWidth: 1, borderRadius: 10, marginBottom: 20 }}>
              ...
              <View style={{ padding: 10, flexDirection: 'column' }}>
                ...
                {/* <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', paddingRight: 8 }}>
                  <Switch
                    value={!!residentData?.inactive_type}
              ...
              <View style={{ padding: 10, borderBottomColor: '#C6C6C6', borderBottomWidth: 1 }}>
                ...
                {residentData?.school?.map((s: any, index) => (
                  <View key={index} style={{ marginBottom: 10 }}>
                    {index != 0 && (
                      <TouchableOpacity style={{ alignSelf: 'flex-end', paddingHorizontal: 10, flexDirection: 'row', alignItems: 'center', gap: 5 }}>
                        <Ionicons name={'remove'} color={'#F54927'} size={20} />
                    ...
                    <View style={{ borderWidth: 1, borderColor: '#C6C6C6', borderRadius: 10, marginBottom: 10, height: 50, justifyContent: 'center' }}>
                      ...
                      >
                        ...
                        {options.filter(d => d.category == 'educational attainment_school').map((att) => (

          ...
          <ScrollView style={{ padding: 16 }}>
            ...
            <View style={{ borderColor: '#C6C6C6', borderWidth: 1, borderRadius: 10, marginBottom: 15 }}>
              ...
              <View style={{ flexDirection: 'column', padding: 10, justifyContent: 'space-between' }}>
                ...
                {brgyModalView == true && (
                  <Modal visible={brgyModalView} animationType="slide" transparent>
                    <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.4)", justifyContent: "center", alignItems: "center" }}>
                      <View style={{ width: "90%", backgroundColor: '#fff', borderRadius: 12, padding: 20 }}>
                        ...
                        <TextInput placeholder="Name" style={{ borderWidth: 1, borderColor: "#C6C6C6", borderRadius: 8, padding: 10, marginBottom: 10 }} />
                        <TextInput placeholder="Code" style={{ borderWidth: 1, borderColor: "#C6C6C6", borderRadius: 8, padding: 10, marginBottom: 10 }} />
                        <TextInput placeholder="Municipality" style={{ borderWidth: 1, borderColor: "#C6C6C6", borderRadius: 8, padding: 10, marginBottom: 10 }} />
                        <TextInput placeholder="Province" style={{ borderWidth: 1, borderColor: "#C6C6C6", borderRadius: 8, padding: 10, marginBottom: 10 }} />
                        <TextInput placeholder="Region" style={{ borderWidth: 1, borderColor: "#C6C6C6", borderRadius: 8, padding: 10, marginBottom: 10 }} />

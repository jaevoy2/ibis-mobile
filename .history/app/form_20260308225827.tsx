          ...
          <ScrollView style={{ padding: 16 }}>
            ...
            <View style={{ borderColor: '#C6C6C6', borderWidth: 1, borderRadius: 10, marginBottom: 20 }}>
              ...
              <View style={{ padding: 10 }}>
                ...
                <View style={{ borderWidth: 1, borderColor: '#C6C6C6', borderRadius: 10, height: 40, justifyContent: 'center' }}>
                  <Picker
                    mode="dropdown"
                    selectedValue={residentData?.family_id}
                    onValueChange={(val) => handleOnChange('family_id', val)}
                  >
                    <Picker.Item label="Select Head of Family" value="" style={{ fontSize: 13 }} />
                    {famHeads.map((member) => (
                      <Picker.Item
                        key={member.id}

...
export default function Dashboard() {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#f5f5f5' }}>
            ...
            <View style={{ position: 'absolute', bottom: 0, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, width, backgroundColor: '#fff', height: 80 }}>
                <Pressable>

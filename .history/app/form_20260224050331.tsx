          ...
          <View style={{ padding: 10, flexDirection: 'column' }}>
            ...
            <View style={{ width: '100%', marginBottom: 12 }}>
              ...
              <TouchableOpacity
                ...
                style={{ backgroundColor: '#ebebebff', paddingVertical: 12, borderRadius: 8, alignItems: 'center' }}
              >
                <Text style={{ color: '#000' }}>
                  {form.date_of_death ? form.date_of_death.toDateString() : 'Select date'}
                </Text>
              </TouchableOpacity>
              {showPicker === 'date_of_death' && (
                <DateTimePicker
                  value={form.date_of_death || new Date()}
                  mode="date"
                  display="default"
                  onChange={(_, date) => {
            ...
            <View style={{ width: '100%', marginBottom: 12 }}>
              ...
              >
                <Text style={{ color: '#000' }}>
                  {form.date_of_migration ? form.date_of_migration.toDateString() : 'Select date'}
                </Text>
              </TouchableOpacity>
              {showPicker === 'date_of_migration' && (
                <DateTimePicker
                  value={form.date_of_migration || new Date()}
                  mode="date"
                  display="default"
                  onChange={(_, date) => {

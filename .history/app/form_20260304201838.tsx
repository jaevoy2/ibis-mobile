        ...
        <View style={{ borderColor: '#C6C6C6', borderWidth: 1, borderRadius: 10, marginBottom: 15 }}>
          ...
          <View style={{ flexDirection: 'row', flexWrap: 'wrap', padding: 10, justifyContent: 'space-between' }}>
            ...
            <View style={{ width: '48%', flexDirection: 'row', alignItems: 'center', marginBottom: 12, paddingRight: 8 }}>
              <Switch
                value={residentData?.lgbt ?? false}
                onValueChange={(val) => handleSwitchChange('lgbt', val)}
              />
              <Text style={{ flex: 1, fontSize: 12 }}>LGBTQ+</Text>
            </View>
            <View style={{ width: '48%', flexDirection: 'row', alignItems: 'center', marginBottom: 12, paddingRight: 8 }}>
              <Switch
                value={residentData?.pwd ?? false}
                onValueChange={(val) => handleSwitchChange('pwd', val)}
              />
              <Text style={{ flex: 1, fontSize: 12 }}>PWD</Text>
            </View>
            <View style={{ width: '48%', flexDirection: 'row', alignItems: 'center', marginBottom: 12, paddingRight: 8 }}>
              <Switch
                value={residentData?.ethnicity ?? false}
                onValueChange={(val) => handleSwitchChange('ethnicity', val)}
              />

              ...
              {residentData?.school?.map((s: any, index) => (
                <View key={index}>
                  ...
                  />
                    ...
                    {options.filter(opt => opt.category.toLowerCase() == 'educational attainment/school')
                    .find(opt => opt.name.toLowerCase() == 'college')?.id == (residentData.school && residentData.school[index].educational_attainment_school_id) && (
                      <>
                        ...
                        <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.4)", justifyContent: "center", alignItems: "center" }}>
                          <View style={{ width: "90%", backgroundColor: '#fff', borderRadius: 12, padding: 20 }}>
                            ...
                            <View style={{ marginBottom: 10 }}>
                              ...
                              <TextInput editable={false} placeholder="Category" style={{ borderWidth: 1, borderColor: "#C6C6C6", opacity: 0., borderRadius: 8, padding: 10 }}
                              value= {options.filter(opt => opt.category == 'educational attainment/school')

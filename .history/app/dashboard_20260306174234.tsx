...
export default function Dashboard() {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#f5f5f5' }}>
            ...
            <View style={{ position: 'absolute', bottom: 40, alignSelf: 'center', width: 80, height: 80, borderRadius: 40, backgroundColor: '#f5f5f5', zIndex: 5 }} />
            <View style={{ position: 'absolute', bottom: 0, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 50, width, backgroundColor: '#fff', height: 80 }}>
                <Pressable>
                    <MaterialCommunityIcons name={'view-dashboard-outline'} size={25} />
                </Pressable>
                <Pressable>

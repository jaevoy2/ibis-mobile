              ...
              <View style={{ padding: 10 }}>
                ...
                <View style={{ width: '100%', marginBottom: 12 }}>
                  ...
                  <Dropdown
                    ...
                    onChange={item => handleOnChange('sitio_id', Number(item.value))}
                  />
                </View>
            ...
            <View style={{ borderColor: '#C6C6C6', borderWidth: 1, borderRadius: 10, marginBottom: 20 }}>
              ...
              <View style={{ padding: 10 }}>  
                ...
                <View style={{ borderWidth: 1, borderColor: '#C6C6C6', borderRadius: 10, marginBottom: 10, height: 50, justifyContent: 'center' }}>
                  <Picker
                    mode='dropdown'
                    selectedValue={residentData?.educational_attainment_school_id ?? null}
                    onValueChange={(val) => handleOnChange('educational_attainment_school_id', Number(val))}
                  >

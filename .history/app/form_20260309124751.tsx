                  ...
                  <Modal visible={brgyModalView} animationType="fade" transparent>
                    <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.4)", justifyContent: "center", alignItems: "center" }}>
                      <View style={{ width: "90%", backgroundColor: '#fff', borderRadius: 12, padding: 20 }}>
                        <Text style={{ marginBottom: 15, fontSize: 18, fontWeight: 'bold' }}>Add Barangay</Text>
                        <View style={{ marginBottom: 10 }}>
                          <Text style={{ flex: 1, fontSize: 12 }}>Name</Text>
                          <TextInput placeholder="Name" style={{ borderWidth: 1, borderColor: "#C6C6C6", borderRadius: 8, padding: 10 }} />
                        </View>
                        <View style={{ marginBottom: 10 }}>
                          <Text style={{ flex: 1, fontSize: 12 }}>Code</Text>
                          <TextInput placeholder="Code" style={{ borderWidth: 1, borderColor: "#C6C6C6", borderRadius: 8, padding: 10 }} />
                        </View>
                        <View style={{ marginBottom: 10 }}>
                          <Text style={{ flex: 1, fontSize: 12 }}>Municipality</Text>
                          <TextInput placeholder="Municipality" style={{ borderWidth: 1, borderColor: "#C6C6C6", borderRadius: 8, padding: 10 }} />
                        </View>
                        <View style={{ marginBottom: 10 }}>
                          <Text style={{ flex: 1, fontSize: 12 }}>Province</Text>
                          <TextInput placeholder="Province" style={{ borderWidth: 1, borderColor: "#C6C6C6", borderRadius: 8, padding: 10 }} />
                        </View>
                        <View style={{ marginBottom: 10 }}>
                          <Text style={{ flex: 1, fontSize: 12 }}>Region</Text>
                          <TextInput placeholder="Region" style={{ borderWidth: 1, borderColor: "#C6C6C6", borderRadius: 8, padding: 10 }} />
                        </View>

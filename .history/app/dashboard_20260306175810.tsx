        ...
        <View style={{ flex: 1, backgroundColor: '#f5f5f5' }}>
            ...
            <View style={{ borderTopLeftRadius: 20, borderTopRightRadius: 20, elevation: 8, position: 'absolute', bottom: 0, flexDirection: 'row', justifyContent: 'space-between',
                ...
                <TouchableOpacity style={{ padding: 20, flexDirection: 'column', alignItems: 'center' }}>
                    <MaterialCommunityIcons name={'view-dashboard'} color={'#306060'} size={25} />
                    <Text style={{ color: '#306060', fontSize: 13 }}>Dashboard</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => router.push('/settings')} style={{ padding: 20, flexDirection: 'column', alignItems: 'center' }}>

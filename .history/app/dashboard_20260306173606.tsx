...
export default function Dashboard() {
    ...
    return (
        <View style={{ flex: 1, backgroundColor:  }}>
            ...
            <View style={{ shadowColor: '#000', shadowOffset: { width: 0, height: -4 }, shadowOpacity: 0.2, position: 'absolute', bottom: 0, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 10, width }}>
                <Pressable>
                    <MaterialCommunityIcons name={'view-dashboard-outline'} size={22} />
                </Pressable>
                <Pressable>

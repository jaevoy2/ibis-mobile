import { addBrgys, addResident } from '@/utils/supaSync';
...
export default function ResidentForm() {
  ...
  const [strandModalView, setStrandModalView] = useState(false);
                    ...
                    .find(opt => opt.name == 'Senior High School')?.id == (residentData.school && residentData.school[index].educational_attainment_school_id) && (
                      <>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: '#C6C6C6', borderRadius: 8, width: '100%', marginBottom: 12 }}>
                          ...
                          />
                          <TouchableOpacity onPress={() => setStrandModalView(true)} style={{ paddingHorizontal: 10, justifyContent: 'center', borderLeftWidth: 1, borderLeftColor: '#C6C6C6', height: 45 }}>
                            <Ionicons name={'add'} size={20} />
                          </TouchableOpacity>
                        </View>
                      </>
                    )}
                    {strandModalView == true && (
                      <Modal visible={strandModalView} animationType="fade" transparent>
                        <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.4)", justifyContent: "center", alignItems: "center" }}>
                          <View style={{ width: "90%", backgroundColor: '#fff', borderRadius: 12, padding: 20 }}>
                            <View style={{ flexDirection: 'row', alignContent: 'center', gap: 5, marginBottom: 15 }}>
                              <Ionicons name={'bookmark'} size={20} color={'#306060'} />
                              <Text style={{ fontSize: 18, fontWeight: 'bold', color: '#306060' }}>Add Strand</Text>
                            </View>
                            <View style={{ marginBottom: 10 }}>
                              <Text style={{ fontSize: 12 }}>Strand Name</Text>
                              <TextInput onChangeText={(text) => handleAddOptionChange('name', text)} placeholder="Strand Name" style={{ borderWidth: 1, borderColor: "#C6C6C6", borderRadius: 8, padding: 10 }} />
                            </View>
                            <View style={{ marginBottom: 10 }}>
                              <Text style={{ fontSize: 12 }}>Category</Text>
                              <TextInput onChangeText={(text) => handleAddOptionChange('category', text)} placeholder="Category" style={{ borderWidth: 1, borderColor: "#C6C6C6", borderRadius: 8, padding: 10 }} />
                            </View>
                            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 5, alignSelf: 'flex-end' }}>
                                <TouchableOpacity onPress={() => setStrandModalView(false)} style={{ padding: 10 }}>
                                  <Text style={{ color: '#919191' }}>Cancel</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={{ paddingVertical: 10, paddingHorizontal: 15, borderRadius: 8, backgroundColor: '#306060' }}>
                                    <Text style={{ color: '#fff', fontWeight: '600' }}>Save</Text>
                                </TouchableOpacity>
                            </View>
                          </View>
                    ...
                    .find(opt => opt.name == 'College')?.id == (residentData.school && residentData.school[index].educational_attainment_school_id) && (
                      <>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: '#C6C6C6', borderRadius: 8, width: '100%', marginBottom: 12 }}>
                          ...
                          />
                          <TouchableOpacity style={{ paddingHorizontal: 10, justifyContent: 'center', borderLeftWidth: 1, borderLeftColor: '#C6C6C6', height: 45 }}>
                            <Ionicons name={'add'} size={20} />
                          </TouchableOpacity>
                        </View>
                      </>

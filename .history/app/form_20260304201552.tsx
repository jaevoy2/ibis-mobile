...
export default function ResidentForm() {
  const [residentData, setResidentData] = useState<ResidentData | null>({ 
    lgbt: false,
    pwd: false,
    ethnicity: false
  });
  ...
  const handleSwitchChange = (key: keyof ResidentData, value: boolean) => {
    setSwitchState(prev => ({ 
      ...prev, [key]: value 
    }));
  };
      ...
      <ScrollView style={{ padding: 16 }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 12 }}>
              ...
              <View style={{ width: '48%' }}>
                ...
                <View style={{ borderColor: '#C6C6C6', borderWidth: 1, borderRadius: 10 }}>
                  <Picker
                    mode="dropdown"
                    selectedValue={residentData?.sitio_id}
                    onValueChange={(val) => handleOnChange('sitio_id', val)}
                  >
        ...
        <View style={{ borderColor: '#C6C6C6', borderWidth: 1, borderRadius: 10, marginBottom: 15 }}>
          ...
          <View style={{ flexDirection: 'row', flexWrap: 'wrap', padding: 10, justifyContent: 'space-between' }}>
            ...
            <View style={{ width: '48%', flexDirection: 'row', alignItems: 'center', marginBottom: 12, paddingRight: 8 }}>
              <Switch
                value={residentData?.lgbt}
                onValueChange={() => handleSwitchChange('lgbt', !residentData?.lgbt)}
              />
            ...
            <View style={{ width: '48%', flexDirection: 'row', alignItems: 'center', marginBottom: 12, paddingRight: 8 }}>
              <Switch
                ...
                onValueChange={() => handleSwitchChange('pwd', !residentData?.pwd)}
              />
            ...
            <View style={{ width: '48%', flexDirection: 'row', alignItems: 'center', marginBottom: 12, paddingRight: 8 }}>
              <Switch
                ...
                onValueChange={() => handleSwitchChange('ethnicity', residentData?.ethnicity)}
              />

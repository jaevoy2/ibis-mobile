  ...
  return (
    <View style={{ paddingBottom: 50, height }}>
      ...
      <ScrollView style={{ padding: 16 }}>
        ...
        {/* Special Status */}
        <View style={{ borderColor: '#C6C6C6', borderWidth: 1, borderRadius: 10, marginBottom: 15, padding: 10 }}>
          <Text style={{ fontWeight: '700', marginBottom: 10 }}>Special Status</Text>
        ...
        <View style={{ marginBottom: 20 }}>
          <Text style={{ fontWeight: '700', marginBottom: 10 }}>Government IDs</Text>
          <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>

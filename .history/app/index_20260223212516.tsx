import { residents$ as _residents$, addResident } from '@/utils/supaSync';
...
useEffect(() => {
  const Resident = observer(({ resident$ }: { resident$: typeof _residents$ }) => {
    // Get the todos from the state and subscribe to updates
    const resident = resident$.get()
    if (resident)
      console.log("residents synced/changed");
      return <></>
  ...
  return (
    <View style={{ paddingBottom: 100 }}>
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#2FA26C', width, height: 90, paddingTop: 35, paddingHorizontal: 10  }}>
        <Text style={{ color: '#fff', fontSize: 20, fontWeight: 'bold' }}>Add Resident</Text>
      </View>
      <ScrollView style={{ padding: 16 }}>
        ...
        {/* Submit button */}
        <TouchableOpacity onPress={() => handleSubmit()} style={{ padding: 8, backgroundColor: '#2FA26C', marginBottom: 20 }}>

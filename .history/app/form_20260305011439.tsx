...
import { Dimensions, KeyboardAvoidingView, Platform, Pressable, ScrollView, Switch, Text, TextInput, TouchableOpacity, View } from 'react-native';
        ...
        <ScrollView style={{ padding: 16 }}>
          ...
          <View style={{ borderColor: '#C6C6C6', borderWidth: 1, borderRadius: 10, marginBottom: 15 }}>
            ...
            <View style={{ padding: 10 }}>
              ...
              <View style={{ borderColor: '#C6C6C6', borderWidth: 1, borderRadius: 10, height: 50 }}>
                <Picker
                  mode="dropdown"

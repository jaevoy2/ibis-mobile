...
export default function ResidentForm() {
  ...
  const handleAssigning = async () => {
    try {
      ...
      const options: any = await db.getAllAsync(`SELECT * FROM options`);
      const families: any = await db.getAllAsync(`SELECT * FROM families`);
      ...
      setLoading(false)
      console.log(families[0].family_name)
    }
  }

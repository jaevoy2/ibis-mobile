...
const getInitialForm = () => ({
  ...
  return (
    <View style={{ paddingBottom: 100, height }}>
      <View style={{ flexDirection: 'row', gap: 10, alignItems: 'center', backgroundColor: '#306060', width, height: 100, paddingTop: 35, paddingHorizontal: 10 }}>

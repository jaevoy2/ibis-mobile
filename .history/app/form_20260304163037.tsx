        ...
        <View style={{ borderColor: '#C6C6C6', borderWidth: 1, borderRadius: 10, marginBottom: 15 }}>
          ...
          <View style={{ flexDirection: 'row' }}>
            <View style={{ flexDirection: 'column', padding: 10, justifyContent: 'space-between' }}>
              {specialStatus.filter(item => item != 'Solo Parent' && item != 'Indigenous People').map((item, index) => (
            ...
            <View style={{ flexDirection: 'column', padding: 10, justifyContent: 'space-between' }}>
              {specialStatus.filter(item => !item.includes('4Ps Member') && !item.includes('Senior') && !item.includes('Indigent Senior') && !item.includes('Pensioner') && !item.includes('OFW')).map((item, index) => (
                <View key={index} style={{ width: '48%', flexDirection: 'row', alignItems: 'center', marginBottom: 12, paddingRight: 8 }}>
                  <Switch
                    value={!!switchState[item]}
                    onValueChange={(val) => handleSwitchChange(item, val)}
